...
pub use artifact::{
    ...
    validate_preparation_policy, ArtifactFormat, ArtifactInspection, MaterializationRoute,
    ModelArtifact, ModelConfiguration, ModelConfigurationResolver, ModelKind, ModelPreparationPlan,
...
pub use speculative::{
    ...
    SpeculativeGenerationRequest, SpeculativeOptimisticBranch, SpeculativeOutputError,
    ...
    SpeculativeRequestTable, SpeculativeSampling, SpeculativeSchedule,
