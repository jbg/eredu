...
//! PyTorch fixture generated by
//! `validation/personaplex_torch_fixture.py`.
//!
//! Generate and run explicitly from the `eredu-backend-mlx` crate directory:
//!
//! ```text
...
//! cargo run --example personaplex_torch_parity -- \
