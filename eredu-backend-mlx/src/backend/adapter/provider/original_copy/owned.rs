...
fn overflow() -> HostMetadataFundingError {
...
impl PreparedOriginalCopyEnvironment {
    fn preparation_controls() -> Option<usize> {
        let parts = [
            size_of::<Self>(),
            size_of::<Result<Self, PreparedOriginalCopyEnvironmentError>>(),
            ...
            size_of::<
                Result<
                    PreparedStreamCopy<CopyEnvironmentCustody>,
                    StreamCopyError<CopyEnvironmentCustody>,
                >,
            >(),
            size_of::<(
            ...
            size_of::<CopyEnvironmentCustody>(),
    ...
    pub(crate) fn prepare(
        ...
        let parts = [
            ...
            plan.source_comparison_control_bytes()
                .ok_or_else(overflow)?,
        ];
