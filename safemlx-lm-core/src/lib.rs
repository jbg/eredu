...
pub use speculative::{
    ...
    SamplingPlacement, SpeculativeAction, SpeculativeCallbackPublisher, SpeculativeCandidate,
    SpeculativeCommit, SpeculativeConstraint, SpeculativeContinuation, SpeculativeDraft,
    SpeculativeDraftBlock, SpeculativeDriverError, SpeculativeExecutionTopology,
