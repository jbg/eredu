...
pub enum PipelineLayerCache {
    ...
    DeepSeekV4 {
        ...
        cache: crate::backend::mlx::architectures::deepseek_v4::attention::AttentionCache,
    },
}
...
struct DeepSeekStage {
    ...
    layer_adapter:
        crate::backend::mlx::architectures::deepseek_v3::layerwise::DeepSeekV3LayerwiseAdapter,
    range: Range<usize>,
    embedding: Option<MaybeQuantized<nn::Embedding>>,
...
struct GptOssStage {
    ...
    layer_adapter: crate::backend::mlx::architectures::gpt_oss::layerwise::GptOssLayerwiseAdapter,
    range: Range<usize>,
    embedding: Option<MaybeQuantized<nn::Embedding>>,
...
impl PipelineStageSemantics for DeepSeekStage {
    ...
    fn prompt_cache_model_identity(
        ...
        Ok(pipeline_prompt_cache_identity(
            ...
            "deepseek_v3",
            &self.args.model_type,
            crate::backend::mlx::architectures::deepseek_v3::model::prompt_cache_architecture_fingerprint(
                &self.args,
            ),
            usize::try_from(self.args.num_hidden_layers)
...
impl PipelineStageSemantics for DeepSeekV4Stage {
    ...
    fn prompt_cache_model_identity(
        ...
        let layer_count =
            crate::backend::mlx::architectures::deepseek_v4::model::prompt_cache_layer_count(
                &self.args,
            );
        ...
        crate::backend::mlx::architectures::deepseek_v4::model::prompt_cache_model_identity_for_range(
            &self.args,
    ...
    fn new_cache_layers(
        ...
        self.range
            ...
            .map(|global_layer| {
                let cache = match &paged {
                    Some((manager, rank)) => crate::backend::mlx::architectures::deepseek_v4::attention::AttentionCache::new_paged_for_ratio(
                    ...
                    None => crate::backend::mlx::architectures::deepseek_v4::attention::AttentionCache::new_for_ratio(
                        self.args.compress_ratios[global_layer],
                        self.args.sliding_window,
                    )?,
                };
...
impl PipelineStageSemantics for GemmaStage {
    ...
    fn placed_ingress_active(&self, group: &str, state: &dyn Any) -> Result<bool, Error> {
        let state = state
            .downcast_ref::<crate::backend::mlx::architectures::gemma4::layerwise::Gemma4PipelineIngressState>()
    ...
    fn replace_placed_ingress_arrays(
        ...
        let state = state
            .downcast_mut::<crate::backend::mlx::architectures::gemma4::layerwise::Gemma4PipelineIngressState>()
            .ok_or_else(|| Error::Parallel("Gemma placed ingress state type mismatch".into()))?;
        self.layer_adapter
    ...
    fn finish_placed_ingress(
        ...
        let state = state
            .downcast::<crate::backend::mlx::architectures::gemma4::layerwise::Gemma4PipelineIngressState>()
    ...
    fn prompt_cache_model_identity(
        ...
        let complete = if self.parallel_layout.is_some() {
            ...
            crate::backend::mlx::architectures::gemma4::model::prompt_cache_layer_layout(
                &self.args,
            )?
        };
        ...
        Ok(pipeline_prompt_cache_identity(
            ...
            "gemma4",
            &self.args.model_type,
            crate::backend::mlx::architectures::gemma4::model::prompt_cache_architecture_fingerprint(&self.args),
            usize::try_from(self.args.num_hidden_layers)
...
impl PipelineStageSemantics for Qwen3VlStage {
    ...
    fn placed_ingress_active(&self, _group: &str, state: &dyn Any) -> Result<bool, Error> {
        let state = state
            .downcast_ref::<crate::backend::mlx::architectures::qwen::vl::layerwise::Qwen3VlPipelineIngressState>(
            )
    ...
    fn replace_placed_ingress_arrays(
        ...
        let state = state
            .downcast_mut::<crate::backend::mlx::architectures::qwen::vl::layerwise::Qwen3VlPipelineIngressState>(
            )
            .ok_or_else(|| Error::Parallel("Qwen3-VL placed ingress state type mismatch".into()))?;
        self.layer_adapter
            .replace_pipeline_ingress_arrays(state, arrays)
    ...
    fn finish_placed_ingress(
        ...
        let state = state
            .downcast::<crate::backend::mlx::architectures::qwen::vl::layerwise::Qwen3VlPipelineIngressState>()
...
impl PipelineStageSemantics for QwenHybridStage {
    ...
    fn placed_ingress_active(&self, _group: &str, state: &dyn Any) -> Result<bool, Error> {
        let state = state
            .downcast_ref::<crate::backend::mlx::architectures::qwen::hybrid::layerwise::QwenHybridPipelineIngressState>()
    ...
    fn replace_placed_ingress_arrays(
        ...
        let state = state
            .downcast_mut::<crate::backend::mlx::architectures::qwen::hybrid::layerwise::QwenHybridPipelineIngressState>()
            .ok_or_else(|| Error::Parallel("Qwen3.5 placed ingress state type mismatch".into()))?;
        self.layer_adapter
            .replace_pipeline_ingress_arrays(state, arrays)
    }
    ...
    fn finish_placed_ingress(
        ...
        let state = state
            .downcast::<crate::backend::mlx::architectures::qwen::hybrid::layerwise::QwenHybridPipelineIngressState>()
...
impl PipelineStageSemantics for InklingStage {
    ...
    fn placed_ingress_active(&self, group: &str, state: &dyn Any) -> Result<bool, Error> {
        let state = state
            .downcast_ref::<crate::backend::mlx::architectures::inkling::layerwise::InklingPipelineIngressState>()
    ...
    fn replace_placed_ingress_arrays(
        ...
        let state = state
            .downcast_mut::<crate::backend::mlx::architectures::inkling::layerwise::InklingPipelineIngressState>()
            .ok_or_else(|| Error::Parallel("Inkling placed ingress state type mismatch".into()))?;
        self.layer_adapter
            .replace_pipeline_ingress_arrays(state, arrays)
    }
    ...
    fn finish_placed_ingress(
        ...
        let state = state
            .downcast::<crate::backend::mlx::architectures::inkling::layerwise::InklingPipelineIngressState>()
...
pub(crate) fn load_pipeline_model_with_options(
        ...
        .is_some_and(|extension| extension.eq_ignore_ascii_case("gguf"))
    {
        ...
        return match architecture {
            crate::core::GgufArchitecture::DeepSeek4 => {
                ...
                let gguf_plan =
                    crate::backend::mlx::architectures::deepseek_v4::checkpoint::gguf_plan(
                        &prepared.args,
                    )
            ...
            crate::core::GgufArchitecture::DeepSeek2 => {
                ...
                let gguf_plan =
                    crate::backend::mlx::architectures::deepseek_v3::checkpoint::gguf_plan(
                        &prepared.args,
                    )
                    .map_err(Error::UnsupportedArchitecture)?;
                let store: SharedWeightStore =
            ...
            crate::core::GgufArchitecture::Gemma4 => {
                ...
                let store =
                    crate::backend::mlx::architectures::gemma4::layerwise::gemma4_gguf_store(
                        &checkpoint,
                        mmproj.as_ref(),
                        &prepared.args,
            ...
            | crate::core::GgufArchitecture::Qwen3Moe) => {
                ...
                let variant = match architecture {
                    crate::core::GgufArchitecture::Qwen2 => {
                        crate::backend::mlx::architectures::qwen::dense::checkpoint::GgufVariant::Qwen2
                    }
                    crate::core::GgufArchitecture::Qwen3Moe => {
                        crate::backend::mlx::architectures::qwen::dense::checkpoint::GgufVariant::Qwen3Moe
                    }
                    _ => crate::backend::mlx::architectures::qwen::dense::checkpoint::GgufVariant::Qwen3,
                };
                let gguf_plan =
                    crate::backend::mlx::architectures::qwen::dense::checkpoint::gguf_plan(
                        &args, variant,
                    )
                    .map_err(Error::UnsupportedArchitecture)?;
                let store: SharedWeightStore =
            ...
            crate::core::GgufArchitecture::Qwen3Vl | crate::core::GgufArchitecture::Qwen3VlMoe => {
                ...
                let store =
                    crate::backend::mlx::architectures::qwen::vl::layerwise::qwen3_vl_gguf_store(
                        &checkpoint,
                        &vision_checkpoint,
                        &prepared.args,
                        max_mapped_shards,
            ...
            crate::core::GgufArchitecture::GptOss => {
                ...
                let gguf_plan = crate::backend::mlx::architectures::gpt_oss::checkpoint::gguf_plan(
                    &prepared.args,
                )
                .map_err(Error::UnsupportedArchitecture)?;
                let store: SharedWeightStore =
            ...
            | crate::core::GgufArchitecture::NemotronHMoe) => {
                ...
                let gguf_plan =
                    crate::backend::mlx::architectures::nemotron_h::checkpoint::gguf_plan(
                        &prepared.args,
                    )
                    .map_err(Error::UnsupportedArchitecture)?;
                let store: SharedWeightStore =
            ...
            | crate::core::GgufArchitecture::Qwen3Next => {
                ...
                let variant = match architecture {
                    ...
                    _ => crate::backend::mlx::architectures::qwen::hybrid::checkpoint::GgufVariant::Qwen35,
                };
            ...
            crate::core::GgufArchitecture::KimiLinear => {
                ...
                let gguf_plan =
                    crate::backend::mlx::architectures::kimi_linear::checkpoint::gguf_plan(
                        &prepared.args,
                    )
                    .map_err(Error::UnsupportedArchitecture)?;
                let store: SharedWeightStore =
            ...
            crate::core::GgufArchitecture::Inkling => {
                ...
                let store =
                    crate::backend::mlx::architectures::inkling::layerwise::inkling_gguf_store(
                        &checkpoint,
                        mmproj.as_ref(),
                        &prepared.args,
                        max_mapped_shards,
    ...
    match model_type {
        ...
        Some("qwen3_next") => {
            load_qwen_hybrid_pipeline(
                crate::backend::mlx::architectures::qwen::hybrid::qwen3_next::get_qwen3_next_model_args(
                    model_dir,
                )?,
                None,
                None,
...
fn load_gpt_oss_pipeline(
    ...
    let binding_adapter = if expert_cache_options.is_some() {
        crate::backend::mlx::architectures::gpt_oss::layerwise::GptOssLayerwiseAdapter::new_external_experts(
            source_args.clone(),
            stream,
        )?
    } else {
        crate::backend::mlx::architectures::gpt_oss::layerwise::GptOssLayerwiseAdapter::new(
            source_args.clone(),
            stream,
        )?
    };
    ...
    if let Some(options) = expert_cache_options {
        let entries = crate::backend::mlx::architectures::gpt_oss::layerwise::gpt_oss_expert_catalog_cartesian(
            &source_args,
            store.as_ref(),
            parallel_layout.as_ref(),
        )?
...
fn load_nemotron_h_pipeline(
    ...
    if external_experts {
        let entries =
            crate::backend::mlx::architectures::nemotron_h::layerwise::nemotron_h_pipeline_expert_catalog(
                &source_args,
                store.as_ref(),
                stage.range.clone(),
                info.is_last,
...
fn load_qwen_hybrid_pipeline(
    ...
    vision_config: Option<crate::backend::mlx::architectures::qwen::vl::vision::VisionConfig>,
    store: SharedWeightStore,
    topology: MlxParallelContext,
    requested_quantization: Option<WeightQuantization>,
    dense_stream: Option<PipelineLayerLoadOptions>,
    ...
    if external_experts {
        let entries =
            crate::backend::mlx::architectures::qwen::hybrid::layerwise::qwen_hybrid_pipeline_expert_catalog(
                &source_args,
                store.as_ref(),
                stage.range.clone(),
                info.is_last,
...
impl QwenHybridStage {
    ...
    fn execute_multimodal_ingress_state(
        &mut self,
        state: &mut crate::backend::mlx::architectures::qwen::hybrid::layerwise::QwenHybridPipelineIngressState,
        step: PipelineStep,
        execution: Option<&ParallelExecutionContext<'_>>,
        stream: &Stream,
    ) -> Result<(), Error> {
...
fn load_kimi_linear_pipeline(
    ...
    if let Some(options) = expert_cache_options {
        let entries = crate::backend::mlx::architectures::kimi_linear::layerwise::kimi_expert_catalog_for_layers(
            &source_args,
            store.as_ref(),
            stage.range.clone(),
        )?
...
impl InklingStage {
    ...
    fn execute_placed_media_state(
        &mut self,
        state: &mut crate::backend::mlx::architectures::inkling::layerwise::InklingPipelineIngressState,
        step: PipelineStep,
        execution: Option<&ParallelExecutionContext<'_>>,
        stream: &Stream,
    ) -> Result<(), Error> {
...
struct GemmaPipelineConfig {
    args: gemma4::ModelArgs,
    vision_config: Option<crate::backend::mlx::architectures::gemma4::vision::Gemma4VisionConfig>,
    image_token_id: Option<i32>,
    video_token_id: Option<i32>,
    audio_config: Option<crate::backend::mlx::architectures::gemma4::audio::Gemma4AudioConfig>,
...
fn load_gemma_pipeline(
    ...
    if external_experts {
        ...
        let entries = crate::backend::mlx::architectures::gemma4::layerwise::gemma4_expert_catalog_for_layers(
            &source_args,
            store.as_ref(),
            stage.range.clone(),
            parallel_layout.as_ref(),
...
impl GemmaStage {
    ...
    fn execute_placed_media_state(
        &mut self,
        group: &str,
        state: &mut crate::backend::mlx::architectures::gemma4::layerwise::Gemma4PipelineIngressState,
        step: PipelineStep,
        execution: Option<&ParallelExecutionContext<'_>>,
        stream: &Stream,
    ) -> Result<(), Error> {
    ...
    fn package_placed_ingress(
        &self,
        prepared: crate::backend::mlx::architectures::gemma4::layerwise::Gemma4PipelineIngressOutput,
        step: PipelineStep,
        stream: &Stream,
    ) -> Result<PipelinePayload, Error> {
        if prepared.hidden.dim(0) != step.batch_size
...
fn load_deepseek_pipeline(
    ...
    let external_experts = topology.expert_parallel_size > 1 || expert_cache_options.is_some();
    let mut binding_adapter = if external_experts {
        crate::backend::mlx::architectures::deepseek_v3::layerwise::DeepSeekV3LayerwiseAdapter::new_external_experts(
            source_args.clone(),
            stream,
        )?
    } else {
        crate::backend::mlx::architectures::deepseek_v3::layerwise::DeepSeekV3LayerwiseAdapter::new(
            source_args.clone(),
            stream,
        )?
    };
    ...
    if external_experts {
        let entries =
            crate::backend::mlx::architectures::deepseek_v3::layerwise::deepseek_pipeline_expert_catalog(
                &source_args,
                store.as_ref(),
                stage.range.clone(),
                info.is_last,
