...
pub(crate) struct PhysicalLinear {
    pub(crate) input_dimensions: i32,
    pub(crate) output_dimensions: i32,
    #[param]
    pub(crate) weight: Param<Array>,
    #[param]
    pub(crate) weight_scale_inv: Param<Option<Array>>,
    #[param]
    pub(crate) scales: Param<Option<Array>>,
    #[param]
    pub(crate) biases: Param<Option<Array>>,
    #[param]
    pub(crate) bias: Param<Option<Array>>,
    pub(crate) group_size: i32,
    pub(crate) bits: i32,
    pub(crate) mode: QuantizationMode,
    pub(crate) gguf: Option<WeightQuantization>,
}
