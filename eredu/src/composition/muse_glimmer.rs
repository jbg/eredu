...
pub(crate) struct PreparedMuseInput {
    pub(crate) tokens: Vec<Array>,
    pub(crate) media: Vec<bool>,
    pub(crate) pixels: Option<Array>,
    pub(crate) grid: Vec<(i32, i32, i32)>,
}
...
pub(crate) struct MuseGlimmerPlacedState {
    pub(crate) forward:
        LayeredForwardState<Array, eredu_architectures::muse_glimmer::ForwardContext<Array>>,
    pub(crate) state: MlxKeyValueState,
}
...
impl MuseGlimmerPlacedState {
    pub(crate) fn new(
        forward: LayeredForwardState<
            Array,
            eredu_architectures::muse_glimmer::ForwardContext<Array>,
        >,
...
pub(crate) struct MuseGlimmerPipelineBindings {
    external_experts: bool,
}
