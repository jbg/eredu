...
enum ExpertArchitecture {
    DeepSeekLayerwise(
        Box<crate::composition::mlx_architectures::deepseek_v3::layerwise::DeepSeekV3LayerwiseModel>,
    ),
    DeepSeekV4Layerwise(
        Box<crate::composition::mlx_architectures::deepseek_v4::layerwise::DeepSeekV4LayerwiseModel>,
    ),
    KimiLinearLayerwise(
    ...
    Lfm2Layerwise(Box<crate::composition::mlx_architectures::lfm2::layerwise::Lfm2LayerwiseModel>),
    NemotronHLayerwise(
        Box<crate::composition::mlx_architectures::nemotron_h::layerwise::NemotronHLayerwiseModel>,
    ),
    QwenHybridLayerwise(
...
impl EmbeddedMtpTarget for ExpertParallelEmbeddedMtpTarget<'_> {
    ...
    fn prefill_draft_cache(
        ...
        {
            return <crate::composition::mlx_architectures::deepseek_v4::layerwise::DeepSeekV4LayerwiseModel as EmbeddedMtpTarget>::prefill_draft_cache(
    ...
    fn advance_draft_cache(
        ...
        {
            return <crate::composition::mlx_architectures::deepseek_v4::layerwise::DeepSeekV4LayerwiseModel as EmbeddedMtpTarget>::advance_draft_cache(
    ...
    fn fused_draft_logits(
        ...
        match (&mut self.model.architecture, cache) {
            (
                ExpertArchitecture::DeepSeekV4Layerwise(model),
                ExpertParallelMtpDraftCache::DeepSeekV4(cache),
            ) => <crate::composition::mlx_architectures::deepseek_v4::layerwise::DeepSeekV4LayerwiseModel as EmbeddedMtpTarget>::fused_draft_logits(
    ...
    fn adjust_fused_draft_logits(
        ...
        match &mut self.model.architecture {
            ExpertArchitecture::DeepSeekV4Layerwise(model) => {
                <crate::composition::mlx_architectures::deepseek_v4::layerwise::DeepSeekV4LayerwiseModel as EmbeddedMtpTarget>::adjust_fused_draft_logits(
    ...
    fn forward_embedded_mtp_draft(
        ...
        let output = match (&mut self.architecture, cache) {
            ...
            (
                ...
                let (logits, hidden) = <crate::composition::mlx_architectures::deepseek_v4::layerwise::DeepSeekV4LayerwiseModel as EmbeddedMtpTarget>::draft_logits(
...
fn load_external_gguf_ep(
    ...
    match architecture {
        "kimi-linear" => {
            ...
            let gguf_plan = crate::composition::mlx_architectures::kimi_linear::checkpoint::gguf_plan(&args)
            ...
            let model = if topology.tensor_parallel_size > 1 {
                crate::composition::mlx_architectures::kimi_linear::layerwise::
            ...
            let entries =
                crate::composition::mlx_architectures::kimi_linear::layerwise::kimi_expert_catalog(
                    &args,
                    store.as_ref(),
                )?;
        ...
        "deepseek4" => {
            ...
            let gguf_plan = crate::composition::mlx_architectures::deepseek_v4::checkpoint::gguf_plan(&args)
                .map_err(Error::UnsupportedArchitecture)?;
            let store: std::sync::Arc<dyn eredu_checkpoint::store::CheckpointSource> =
                std::sync::Arc::new(open_gguf_checkpoint_source(
                    checkpoint.clone(),
            ...
            let model = if topology.tensor_parallel_size > 1 {
                crate::composition::mlx_architectures::deepseek_v4::layerwise::
            ...
            let store = model.checkpoint_store_arc();
            let entries = crate::composition::mlx_architectures::deepseek_v4::layerwise::expert_catalog(
                &args,
                store.as_ref(),
            )?;
            let replicated_parameter_bytes =
        ...
        "deepseek2" => {
            ...
            let gguf_plan = crate::composition::mlx_architectures::deepseek_v3::checkpoint::gguf_plan(&args)
                .map_err(Error::UnsupportedArchitecture)?;
            let store: std::sync::Arc<dyn eredu_checkpoint::store::CheckpointSource> =
                std::sync::Arc::new(open_gguf_checkpoint_source(
                    checkpoint.clone(),
            ...
            let model = if topology.tensor_parallel_size > 1 {
                crate::composition::mlx_architectures::deepseek_v3::layerwise::
            ...
            let store = model.checkpoint_store_arc();
            let entries =
                crate::composition::mlx_architectures::deepseek_v3::layerwise::deepseek_expert_catalog(
                    &args,
                    store.as_ref(),
                )?;
            let replicated_parameter_bytes =
        ...
        "lfm2moe" => {
            ...
            let assignment =
                resolve_model_assignment(assignment, args.num_experts as usize, topology)?;
            let gguf_plan = crate::composition::mlx_architectures::lfm2::checkpoint::gguf_plan(&args)
                .map_err(Error::UnsupportedArchitecture)?;
            let store: std::sync::Arc<dyn eredu_checkpoint::store::CheckpointSource> =
                std::sync::Arc::new(open_gguf_checkpoint_source(
                    checkpoint.clone(),
            ...
            let model = if topology.tensor_parallel_size > 1 {
                crate::composition::mlx_architectures::lfm2::layerwise::load_lfm2_sparse_tp_ep_base_with_store(
                    store.clone(),
                    args.clone(),
                    non_expert,
                    ParallelBuildContext::new(topology, ShardingPolicy::Require),
                ...
                crate::composition::mlx_architectures::lfm2::layerwise::load_lfm2_sparse_ep_base_with_store(
                    store.clone(),
                    args.clone(),
                    non_expert,
                    stream,
            ...
            let store = model.checkpoint_store_arc();
            let entries =
                crate::composition::mlx_architectures::lfm2::layerwise::lfm2_expert_catalog(
                    &args,
                    store.as_ref(),
                )?;
            let replicated_parameter_bytes =
        ...
        "nemotron_h_moe" => {
            ...
            let gguf_plan = crate::composition::mlx_architectures::nemotron_h::checkpoint::gguf_plan(&args)
                .map_err(Error::UnsupportedArchitecture)?;
            let store: std::sync::Arc<dyn eredu_checkpoint::store::CheckpointSource> =
                std::sync::Arc::new(open_gguf_checkpoint_source(
                    checkpoint.clone(),
            ...
            let model = if topology.tensor_parallel_size > 1 {
                crate::composition::mlx_architectures::nemotron_h::layerwise::
            ...
            let store = model.checkpoint_store_arc();
            let entries =
                crate::composition::mlx_architectures::nemotron_h::layerwise::nemotron_h_expert_catalog(
                    &args,
                    store.as_ref(),
                )?;
            let replicated_parameter_bytes =
...
fn load_kimi_linear_external_ep(
    ...
    let model = if topology.tensor_parallel_size > 1 {
        crate::composition::mlx_architectures::kimi_linear::layerwise::load_kimi_linear_sparse_tp_ep_base_with_store(
            store.clone(),
            args.clone(),
            non_expert,
            ParallelBuildContext::new(topology, ShardingPolicy::Require),
        ...
        crate::composition::mlx_architectures::kimi_linear::layerwise::load_kimi_linear_sparse_ep_base_with_store(
            store.clone(),
            args.clone(),
            non_expert,
            stream,
...
fn load_deepseek_external_ep(
    ...
    let model = if topology.tensor_parallel_size > 1 {
        crate::composition::mlx_architectures::deepseek_v3::layerwise::load_deepseek_v3_sparse_tp_ep_base_with_store(
            store.clone(),
            args.clone(),
            non_expert,
            ParallelBuildContext::new(topology, ShardingPolicy::Require),
        ...
        crate::composition::mlx_architectures::deepseek_v3::layerwise::load_deepseek_v3_sparse_ep_base_with_store(
            store.clone(),
            args.clone(),
            non_expert,
            stream,
...
fn load_deepseek_v4_external_ep(
    ...
    let model = if topology.tensor_parallel_size > 1 {
        crate::composition::mlx_architectures::deepseek_v4::layerwise::load_deepseek_v4_sparse_tp_ep_base_with_store(
            store.clone(),
            args.clone(),
            non_expert,
            options.quantization,
        ...
        crate::composition::mlx_architectures::deepseek_v4::layerwise::load_deepseek_v4_sparse_ep_base_with_store(
            store.clone(),
            args.clone(),
            non_expert,
            options.quantization,
...
fn load_additional_external_ep(
    ...
    let (assignment, architecture, store, entries, replicated_parameter_bytes) = match kind {
        ...
        ModelKind::NemotronH => {
            ...
            let store = model.checkpoint_store_arc();
            let entries = crate::composition::mlx_architectures::nemotron_h::layerwise::nemotron_h_expert_catalog(
                &args,
                store.as_ref(),
            )?;
            let replicated = planned_replicated_bytes(&model.residency_report()?)?;
