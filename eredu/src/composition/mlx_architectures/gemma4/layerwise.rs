...
impl Gemma4LayerwiseAdapter {
    ...
    fn new(
        ...
        let lm_head = if args.tie_word_embeddings {
            ...
            Some(
                crate::backend::mlx::nn::linear::build_unloaded_maybe_quantized_lm_head_with_quantization(
                    args.hidden_size,
                    args.vocab_size,
...
impl ArchitectureAdapter for Gemma4LayerwiseAdapter {
    ...
    fn register_parallel_parameters(
        ...
        if let Some(projection) = &self.per_layer_projection {
            crate::backend::mlx::nn::parallel::register_linear_parameter_group(
                planner,
                projection,
                "model.language_model.per_layer_model_projection",
    ...
    fn configure_parallel_static(
        ...
        if let Some(vision) = &mut self.vision {
            ...
            vision.patch_embedder =
                crate::composition::mlx_architectures::gemma4::vision::VisionPatchEmbedder::new_tensor_parallel(
                    &vision.config,
                    range.len() as i32,
