...
impl VisionStatic {
    ...
    pub(crate) fn begin(
        ...
        let (window_index, window_chunks) =
            crate::composition::mlx_architectures::qwen::vl::vision::vision_window_index(
                &grid,
                1,
    ...
    pub(crate) fn finish(
        ...
        let reverse = crate::composition::mlx_architectures::qwen::vl::vision::reverse_permutation(
            &state.window_index,
        );
...
fn grid_from_array(array: &Array, stream: &Stream) -> Result<Vec<(i32, i32, i32)>, Exception> {
    crate::composition::mlx_architectures::qwen::vl::vision::grid_thw_from_array(array, stream)
}
