...
fn pipeline_ring_worker() {
    ...
    if std::env::var_os(OPAQUE_SESSION).is_some() {
        ...
        use eredu_backend_mlx::testing::backend::mlx::runtime::media::input::{
    ...
    if matches!(
        ...
        let (generated, stats) = model
            .generate_embedded_mtp_distributed(
                &mut mtp_cache,
                eredu_backend_mlx::testing::backend::mlx::runtime::media::input::ModelInput::new(
                    &parts,
                ),
                &MtpConfig {
                    max_tokens: 3,
...
fn write_deepseek_fixture(directory: &Path, layers: i32) {
    ...
    type Backend = eredu_backend_mlx::testing::backend::mlx::nn::MlxNeuralBackend;
    let architecture =
...
fn qwen_fixture_arrays(
    ...
    let architecture = eredu_architectures::qwen::LayeredModel::<
        eredu_backend_mlx::testing::backend::mlx::nn::MlxNeuralBackend,
...
fn write_lfm2_pipeline_fixture(directory: &Path, moe: bool) {
    ...
    let mut model = eredu_backend_mlx::testing::backend::mlx::nn::MlxModule::new(
