...
macro_rules! ri_maybe_ref {
    (
        ...
        impl $Ty<String> {
            ...
            /// Returns the allocated capacity of this value's actual owned
            /// string. This read-only query does not clone, parse or normalize
            /// the URI and includes any unused capacity retained by its owner.
            #[inline]
            #[must_use]
