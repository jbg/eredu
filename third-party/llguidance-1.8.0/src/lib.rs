...
// Eredu uses the safe Rust parser API. The upstream C ABI is intentionally
// excluded from this local fork so the workspace unsafe-code ban applies.
