...
/// Prospective source and invocation storage policy for the shared workers.
pub mod allocation;
/// Actual retained-source allocation traversal.
pub mod source_storage;
mod search_workspace;
pub use search_workspace::OwnedSearchWorkspace;

/// Typed original search failure, including prospective storage refusal.
pub use regex_automata::MatchError as SearchError;
