...
impl Builder {
    ...
    pub(crate) fn build(
        ...
        self.build_imp(patterns, allocation)
    }
        ...
        ))]
        {
            ...
            match mask_len {
                1 => {
                    ...
                    debug!("Teddy choice: 128-bit slim, 1 byte");
                    SlimNeon::<1>::new(&patterns, allocation)
                }
                2 => {
                    ...
                    debug!("Teddy choice: 128-bit slim, 2 bytes");
                    SlimNeon::<2>::new(&patterns, allocation)
                }
                3 => {
                    ...
                    debug!("Teddy choice: 128-bit slim, 3 bytes");
                    SlimNeon::<3>::new(&patterns, allocation)
                }
                4 => {
                    debug!("Teddy choice: 128-bit slim, 4 bytes");
                    SlimNeon::<4>::new(&patterns, allocation)
                }
                _ => {
                    debug!("no supported Teddy configuration found");
                    Ok(None)
...
impl Searcher {
    pub(crate) fn visit_source_storage(
        ...
        if crate::source_storage::arc(&self.imp, visitor) {
            self.imp.visit_source_storage(visitor);
        }
    }
        ...
        ($len:expr) => {
            impl SlimSSSE3<$len> {
                ...
                pub(super) fn new(
                    ...
                    Ok(Some(unsafe {
                        SlimSSSE3::<$len>::new_unchecked(patterns, allocation)?
                    }))
                }
                ...
                unsafe fn new_unchecked(
                    patterns: &Arc<Patterns>,
                    allocation: Allocator<'_>,
                ) -> Result<Searcher, AllocationError> {
                    ...
                    let imp = allocation.arc(SlimSSSE3 { slim128 })?;
                    Ok(Searcher { imp, memory_usage, minimum_len })
                }
            }
            ...
            impl SearcherT for SlimSSSE3<$len> {
                fn visit_source_storage(
                    ...
                    self.slim128.visit_source_storage(visitor);
                }
                #[target_feature(enable = "ssse3")]
                #[inline]
                unsafe fn find(
        ...
        ($len:expr) => {
            impl SlimAVX2<$len> {
                ...
                pub(super) fn new(
                    ...
                    Ok(Some(unsafe {
                        SlimAVX2::<$len>::new_unchecked(patterns, allocation)?
                    }))
                }
                ...
                unsafe fn new_unchecked(
                    ...
                    let minimum_len = slim128.minimum_len();
                    let imp = allocation.arc(SlimAVX2 { slim128, slim256 })?;
                    Ok(Searcher { imp, memory_usage, minimum_len })
                }
            }
            ...
            impl SearcherT for SlimAVX2<$len> {
                fn visit_source_storage(
                    ...
                    self.slim128.visit_source_storage(visitor);
                    self.slim256.visit_source_storage(visitor);
                }
                #[target_feature(enable = "avx2")]
                #[inline]
                unsafe fn find(
        ...
        ($len:expr) => {
            impl FatAVX2<$len> {
                ...
                pub(super) fn new(
                    ...
                    Ok(Some(unsafe {
                        FatAVX2::<$len>::new_unchecked(patterns, allocation)?
                    }))
                }
                ...
                unsafe fn new_unchecked(
                    ...
                    let imp = allocation.arc(FatAVX2 { fat256 })?;
                    Ok(Searcher { imp, memory_usage, minimum_len })
                }
            }
            ...
            impl SearcherT for FatAVX2<$len> {
                fn visit_source_storage(
                    ...
                    self.fat256.visit_source_storage(visitor);
                }
                #[target_feature(enable = "avx2")]
                #[inline]
                unsafe fn find(
        ...
        ($len:expr) => {
            impl SlimNeon<$len> {
                ...
                pub(super) fn new(
                    ...
                    Ok(Some(unsafe {
                        SlimNeon::<$len>::new_unchecked(patterns, allocation)?
                    }))
                }
                ...
                unsafe fn new_unchecked(
                    ...
                    let memory_usage = slim128.memory_usage();
                    let minimum_len = slim128.minimum_len();
                    let imp = allocation.arc(SlimNeon { slim128 })?;
                    Ok(Searcher { imp, memory_usage, minimum_len })
                }
            }
