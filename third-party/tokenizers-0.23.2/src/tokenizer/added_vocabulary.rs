...
pub use packed::{
    ...
    AddedVocabularyCompileRequirements, AddedVocabularyRefreshPlan,
};
#[derive(Clone)]
...
impl AddedVocabulary {
    /// Find any AddedToken in the given sentence, using the selected normalization phase.
    ...
    pub(crate) fn raw_literals(&self) -> bool {
        self.tokens().all(|(_, t)| {
