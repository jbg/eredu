...
impl SparseSet {
    ...
    // calls resize inside those capacities. No buffer escapes this module.
    #[cfg(feature = "nfa-pikevm")]
    pub(crate) fn try_reserve_workspace_dense(
        &mut self,
        capacity: usize,
    ) -> Result<(), alloc::collections::TryReserveError> {
        self.dense.try_reserve_exact(capacity)
    }

    #[cfg(feature = "nfa-pikevm")]
    pub(crate) fn try_reserve_workspace_sparse(
        &mut self,
        capacity: usize,
    ) -> Result<(), alloc::collections::TryReserveError> {
        self.sparse.try_reserve_exact(capacity)
    }

    #[cfg(feature = "nfa-pikevm")]
    pub(crate) fn workspace_capacities(&self) -> (usize, usize) {
