//! Independent pre-materialization operation/format/fold reference. See stage ORACLE.md.
#![forbid(unsafe_code)]
use crate::value::{ObjectRepr, Value, ValueRepr};
use std::cmp::Ordering;
mod fold;
pub(crate) mod ops;
pub(crate) use fold::expression;
use std::fmt;
...
pub(crate) struct Display<'a>(pub(crate) &'a Value);
