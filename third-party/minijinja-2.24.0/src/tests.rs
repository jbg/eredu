...
pub fn is_undefined(v: &Value) -> bool {
    crate::value::primitive::Presence::Undefined.check(v.is_undefined(), v.is_none())
}
...
pub fn is_defined(v: &Value) -> bool {
    crate::value::primitive::Presence::Defined.check(v.is_undefined(), v.is_none())
}
...
pub fn is_none(v: &Value) -> bool {
    crate::value::primitive::Presence::None.check(v.is_undefined(), v.is_none())
}
...
mod builtins {
    ...
    use crate::value::ops::{CoerceResult, coerce};
    ...
    pub fn is_boolean(v: &Value) -> bool {
        crate::value::primitive::type_tests::TypeTest::Boolean.check(v)
    }
    ...
    pub fn is_number(v: &Value) -> bool {
        crate::value::primitive::type_tests::TypeTest::Number.check(v)
    }
    ...
    pub fn is_integer(v: &Value) -> bool {
        crate::value::primitive::type_tests::TypeTest::Integer.check(v)
    }
    ...
    pub fn is_float(v: &Value) -> bool {
        crate::value::primitive::type_tests::TypeTest::Float.check(v)
    }
    ...
    pub fn is_string(v: &Value) -> bool {
        crate::value::primitive::type_tests::TypeTest::String.check(v)
    }
    ...
    pub fn is_sequence(v: &Value) -> bool {
        crate::value::primitive::type_tests::TypeTest::Sequence.check(v)
    }
    ...
    pub fn is_iterable(v: &Value) -> bool {
        crate::value::primitive::type_tests::TypeTest::Iterable.check(v)
    }
    ...
    pub fn is_mapping(v: &Value) -> bool {
        crate::value::primitive::type_tests::TypeTest::Mapping.check(v)
    }
    ...
    pub fn is_true(value: &Value) -> bool {
        crate::value::primitive::type_tests::TypeTest::True.check(value)
    }
    ...
    pub fn is_false(value: &Value) -> bool {
        crate::value::primitive::type_tests::TypeTest::False.check(value)
    }
