        ...
        $(
                ...
                F: Json,
            {
                fn original_source(&self, source: &mut crate::validator::source::Inspector<F>) -> Result<(), crate::validator::workspace::Error> {
                    source.value(&self.limit_val)?;
                    source.location(&self.location)
                }
                fn original_controls(&self) -> Result<usize, crate::validator::workspace::Error> {
                    let numeric = crate::numeric::original_comparison_control_bytes::<<F::Node<'_> as crate::Node<'_, F>>::Number, T>()
                        .ok_or(crate::validator::workspace::Error::Unqualified(crate::validator::workspace::Component::Validator("arbitrary-precision number comparison")))?;
