...
impl<'a> ValidationError<'a> {
    ...
    fn borrowed(
        ...
        Self::new(instance, kind, instance_path, schema_path, tracker)
    }
    ...
    /// [`Self::with_context`] variant for macro-generated code, which tracks the instance path as an owned [`Location`].
    #[cfg(feature = "macros")]
