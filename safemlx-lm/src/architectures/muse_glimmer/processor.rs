//! Hugging Face-compatible Muse-Glimmer image and experimental video processor.
...
#[derive(Debug, Clone)]
pub(crate) struct MuseGlimmerProcessor {
    image: VisualConfig,
    video: VisualConfig,
...
fn process_image(
    ...
    Ok(PreparedInputPart::media_tensor(
        Modality::Image,
        patches,
        OwnedInputMetadata::vision_grid_thw(grid),
    ))
}
