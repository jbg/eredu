...
impl VisionStatic {
    ...
    pub(crate) fn begin(
        ...
        let (window_index, window_chunks) =
            crate::architectures::qwen::vl::vision::vision_window_index(
                &grid,
                1,
    ...
    pub(crate) fn finish(
        ...
        let reverse =
            crate::architectures::qwen::vl::vision::reverse_permutation(&state.window_index);
...
impl VisionAttention {
    ...
    fn forward(
        ...
        for &length in chunks {
            ...
            let output = crate::nn::tensor::scaled_dot_product_attention(
                prepare(&q)?,
                prepare(&k)?,
                prepare(&v)?,
...
fn grid_from_array(array: &Array, stream: &Stream) -> Result<Vec<(i32, i32, i32)>, Exception> {
    crate::architectures::qwen::vl::vision::grid_thw_from_array(array, stream)
}
