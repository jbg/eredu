//! MLX artifact companion discovery.
...
/// are present. A sole quantized projector is still returned so architectures
/// whose media towers use checkpoint-native quantization can load it.
pub(crate) fn find_sibling_mmproj(
    gguf_file: &Path,
    architecture: &str,
