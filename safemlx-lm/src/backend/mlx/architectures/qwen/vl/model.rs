...
use crate::{
    backend::mlx::architectures::qwen::{dense as dense_qwen, vl::vision::grid_thw_from_array},
...
mod tests {
    ...
    fn tiny_args() -> super::ModelArgs {
        let text_config = crate::backend::mlx::architectures::qwen::dense::DecoderConfig {
    ...
    fn strict_loads_q8_qwen_vision_from_synthetic_gguf_checkpoints() {
        ...
        let crate::backend::mlx::architectures::distributed::pipeline::PipelineStageOutput::Hidden(
            payload,
        ) = first
            .prefill_stage(
                input,
                crate::backend::mlx::architectures::distributed::pipeline::PipelineStep::new(1, 3)
                    .unwrap(),
                None,
                &mut first_cache,
                stream,
        ...
        let crate::backend::mlx::architectures::distributed::pipeline::PipelineStageOutput::Logits(actual) =
            second
                .forward_stage(
                    crate::backend::mlx::architectures::distributed::pipeline::PipelineStageInput::Hidden(
                        &payload,
                    ),
                    crate::backend::mlx::architectures::distributed::pipeline::PipelineStep::new(1, 3).unwrap(),
                    None,
                    &mut second_cache,
                    stream,
                )
