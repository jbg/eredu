...
//! no companion naming convention. A future architecture can therefore feed
//! the same physical plan to structural admission and its [`binding_plan::BindingPlan`]
//! to resident, layerwise, or streamed loading without adding evaluator logic.
