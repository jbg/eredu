...
impl Drop for MaybeUninitArray {
    fn drop(&mut self) {
        if !self.init_success {
            unsafe {
                safemlx_sys::mlx_array_free(self.ptr);
            }
        }
    }
}
...
pub(crate) struct MaybeUninitVectorArray {
    pub(crate) ptr: safemlx_sys::mlx_vector_array,
    pub(crate) init_success: bool,
}
...
impl MaybeUninitVectorArray {
    pub fn new() -> Self {
        unsafe {
            Self {
                ptr: safemlx_sys::mlx_vector_array_new(),
                init_success: false,
            }
        }
    }
...
impl Drop for MaybeUninitVectorArray {
    fn drop(&mut self) {
        if !self.init_success {
            unsafe {
                safemlx_sys::mlx_vector_array_free(self.ptr);
            }
        }
    }
}
...
impl Guard<Vec<Array>> for MaybeUninitVectorArray {
    type MutRawPtr = *mut safemlx_sys::mlx_vector_array;
    ...
    fn try_into_guarded(mut self) -> Result<Vec<Array>, Exception> {
        ...
        unsafe {
            let size = safemlx_sys::mlx_vector_array_size(self.ptr);
            (0..size)
                .map(|i| {
                    Array::try_from_op(|res| safemlx_sys::mlx_vector_array_get(res, self.ptr, i))
                })
                .collect()
        }
    }
...
impl Guard<(Vec<Array>, Vec<Array>)> for (MaybeUninitVectorArray, MaybeUninitVectorArray) {
    type MutRawPtr = (
        *mut safemlx_sys::mlx_vector_array,
        *mut safemlx_sys::mlx_vector_array,
    );
...
pub(crate) struct MaybeUninitDevice {
    pub(crate) ptr: safemlx_sys::mlx_device,
    pub(crate) init_success: bool,
}
...
impl MaybeUninitDevice {
    pub fn new() -> Self {
        unsafe {
            Self {
                ptr: safemlx_sys::mlx_device_new(),
                init_success: false,
            }
        }
    }
...
impl Drop for MaybeUninitDevice {
    fn drop(&mut self) {
        if !self.init_success {
            unsafe {
                safemlx_sys::mlx_device_free(self.ptr);
            }
        }
    }
}
...
impl Guard<crate::Device> for MaybeUninitDevice {
    type MutRawPtr = *mut safemlx_sys::mlx_device;
...
impl Guarded for crate::DeviceType {
    type Guard = safemlx_sys::mlx_device_type;
}

impl Guard<crate::DeviceType> for safemlx_sys::mlx_device_type {
    type MutRawPtr = *mut safemlx_sys::mlx_device_type;
    ...
    fn try_into_guarded(self) -> Result<crate::DeviceType, Exception> {
        match self {
            safemlx_sys::mlx_device_type__MLX_CPU => Ok(crate::DeviceType::Cpu),
            safemlx_sys::mlx_device_type__MLX_GPU => Ok(crate::DeviceType::Gpu),
            _ => Err(Exception {
...
impl MaybeUninitStream {
    pub fn new() -> Self {
        unsafe {
            Self {
                ptr: safemlx_sys::mlx_stream_new(),
                init_success: false,
            }
        }
    }
...
impl Drop for MaybeUninitStream {
    fn drop(&mut self) {
        if !self.init_success {
            unsafe {
                safemlx_sys::mlx_stream_free(self.ptr);
            }
        }
    }
}
...
impl Guard<crate::Stream> for MaybeUninitStream {
    type MutRawPtr = *mut safemlx_sys::mlx_stream;
...
impl MaybeUninitSafeTensors {
    pub fn new() -> Self {
        unsafe {
            Self {
                c_metadata: safemlx_sys::mlx_map_string_to_string_new(),
                c_data: safemlx_sys::mlx_map_string_to_array_new(),
                init_success: false,
            }
        }
    }
...
impl Guard<crate::utils::io::SafeTensors> for MaybeUninitSafeTensors {
    type MutRawPtr = (
        ...
        *mut safemlx_sys::mlx_map_string_to_string,
    );
...
impl MaybeUninitClosure {
    pub fn new() -> Self {
        unsafe {
            Self {
                ptr: safemlx_sys::mlx_closure_new(),
                init_success: false,
            }
        }
    }
...
impl Drop for MaybeUninitClosure {
    fn drop(&mut self) {
        if !self.init_success {
            unsafe {
                safemlx_sys::mlx_closure_free(self.ptr);
            }
        }
    }
}
...
impl<'a> Guard<crate::utils::Closure<'a>> for MaybeUninitClosure {
    type MutRawPtr = *mut safemlx_sys::mlx_closure;
...
pub(crate) struct MaybeUninitClosureValueAndGrad {
    pub(crate) ptr: safemlx_sys::mlx_closure_value_and_grad,
    pub(crate) init_success: bool,
}
...
impl MaybeUninitClosureValueAndGrad {
    pub fn new() -> Self {
        unsafe {
            Self {
                ptr: safemlx_sys::mlx_closure_value_and_grad_new(),
                init_success: false,
            }
        }
    }
...
impl Drop for MaybeUninitClosureValueAndGrad {
    fn drop(&mut self) {
        if !self.init_success {
            unsafe {
                safemlx_sys::mlx_closure_value_and_grad_free(self.ptr);
            }
        }
    }
}
...
impl Guard<crate::transforms::ClosureValueAndGrad> for MaybeUninitClosureValueAndGrad {
    type MutRawPtr = *mut safemlx_sys::mlx_closure_value_and_grad;
